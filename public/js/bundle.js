...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"displayData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.displayMeals = void 0;
...
var makeAction = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(element, data) {
    var id, method, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            method = element.className === "update" ? "PATCH" : "DELETE";
            _context.prev = 2;
            _context.next = 5;
...
var activateUpdateAndDelete = function activateUpdateAndDelete() {
  var operation = document.querySelectorAll(".operation");

  if (operation) {
    operation.forEach(function (el) {
      el.addEventListener("click", function (e) {
        var data = {};
        var rowData = e.target.closest("tr").querySelectorAll("input");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            results = res.data.data.data; // console.log(results);
            ...
            if (document.querySelector("h3")) document.querySelector("h3").remove(); // remove the add meal message if exists

            _html = "<h3>No Meals till now, Please add a meal to record your data.</h3>";
            date.textContent = d;
          ...
          case 19:
            ...
            html += "</tbody>";
            if (fromDate && document.querySelector("tbody")) document.querySelector("tbody").remove(); // clear the table before adding the data, else it will just append the data.

            date.textContent = d;
            data.insertAdjacentHTML("afterend", html);
            message = "<p>Total Calorie consumed ".concat(fromDate ? "" : "today", " is ").concat(calorieSum, " units.</p>");
            if (res.data.dailyLimitExceeding) message += "<p>Calorie Consumption of today is exceeding by ".concat(res.data.exceedingAmount, " units.</p>");
            if (fromDate) summary.querySelectorAll("p").forEach(function (el) {
              return el.remove();
            }); // clear the messages else it will just append.
...
exports.displayMeals = displayMeals;
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, caloriePerDay, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js"}],"addMeal.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addMeal = void 0;
...
var addMeal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(foodName, calorie, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function addMeal(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var _addMeal = require("./addMeal");

var meals = document.querySelector(".display--meals");
...
if (meals) {
  ...
  if (fromDateForm) {
    ...
    fromDateForm.addEventListener("submit", function (e) {
      e.preventDefault();
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    var caloriePerDay = document.querySelector("#calorie_per_day").value;
    var password = document.querySelector("#password").value;
    var passwordConfirm = document.querySelector("#passwordConfirm").value;
    if (name && email && caloriePerDay && password && passwordConfirm) (0, _userauth.signup)(name, email, +caloriePerDay, password, passwordConfirm);
  });
}
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    var email = document.querySelector("#email").value;
    var password = document.querySelector("#password").value;
    if (email && password) (0, _userauth.login)(email, password);
  });
}

if (logoutBtn) {
  logoutBtn.addEventListener("click", _userauth.logout);
}
